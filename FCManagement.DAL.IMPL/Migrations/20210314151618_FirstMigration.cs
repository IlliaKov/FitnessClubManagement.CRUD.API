...
namespace FCManagement.DAL.IMPL.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeAddress = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    JoiningDate = table.Column<DateTime>(type: "date", nullable: false),
                    EndOfMembership = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
